...
class Index extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "fast", () => {
      // this does not work i do not understand why
      axios__WEBPACK_IMPORTED_MODULE_7___default.a.get(`https://api.fast.co/api/invite?identifier=ddanigrant%40gmail.com&key=qlGznwRgNBrWjpArDVm9xYO3D4eLPX72`).then(res => {
